...
Report a possible violation privately to the project maintainer, Raaneem
([@raaneem](https://github.com/raaneem)), through GitHub's
[private reporting form](https://github.com/raaneem/supernote-cloud-sync/security/advisories/new).
Begin the report title with `Conduct:` and do not include sensitive details in a
public issue. The maintainer will acknowledge the report within seven calendar
days and provide a substantive status update within thirty calendar days.

Reports are taken seriously and investigated using available messages, logs, and
witness accounts. Investigation and enforcement will be kept as transparent as
possible while prioritizing safety and confidentiality. Enforcement actions are
carried out privately with the involved parties, though a mutually agreed
resolution may include communication to the wider community.
...
Depending on severity, lower rungs may be skipped.
...
2. **Temporarily limited activities**
   - Event: A repeated violation after a warning, or the first occurrence of a
     more serious violation.
   - Consequence: A private, written warning with a time-limited cooldown that
     may restrict channels or interactions.
   - Repair may include an apology, reflection during the cooldown, and a
     thoughtful return to community spaces.
3. **Temporary suspension**
   - Event: A repeated pattern that warnings did not resolve, or one serious
     violation.
   - Consequence: A private, written suspension with conditions for return.
   - Repair includes respecting the suspension, meeting its conditions, and
     reintegrating thoughtfully.
4. **Permanent ban**
   - Event: Repeated violations that other steps did not resolve, or a violation
     so serious that community safety cannot otherwise be preserved.
   - Consequence: Access to community spaces, tools, and communication channels
     is removed.

This ladder is a guideline and does not prevent the maintainer from exercising
judgment in the community's best interests.
